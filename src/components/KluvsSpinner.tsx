interface KluvsSpinnerProps {
  size?: number
  color?: string
  className?: string
}

export default function KluvsSpinner({ size = 64, color = 'var(--color-primary, #D16D30)', className = '' }: KluvsSpinnerProps) {
  return (
    <svg
      className={`kluvs-spinner ${className}`}
